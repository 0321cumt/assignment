...
public class BookServiceImpl implements BookService {
	...
	/**
	 * BookService接口getAllEducation方法实现
	 * @see { BookService }
	 * */
	@Transactional(readOnly=true)
	@Override
	public List<Book> getAllEducation() {
		
		return bookMapper.findAllEducation();
	}
	
	/**
	 * BookService接口getAllArt方法实现
	 * @see { BookService }
	 * */
	@Transactional(readOnly=true)
	@Override
	public List<Book> getAllArt() {
		
		return bookMapper.findAllArt();
	}
